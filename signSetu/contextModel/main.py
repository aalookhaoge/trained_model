...
from signSetu.contextModel.utils import clean_words
from signSetu.contextModel.nlp_rules import SentenceGenerator

# 🔹 Replace this with your actual sign detection output
def get_detected_signs():
    return ["me", "want", "help", "fever", "pain", "stomach"]
